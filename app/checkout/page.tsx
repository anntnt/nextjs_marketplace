          ...
          <div className="md:col-span-2 space-y-4">
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>Donau Indel, 1020, Austria</div>
                <Link href="#">Edit</Link>
              </div>
            </div>
          ...
          <div className="space-y-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6bg-white  px-4 py-6 h-max ">
            ...
            <div className="mt-8 space-y-2">
              <Link
                href="/stripe"
                type="button"
                className="w-full text-center text-white bg-blue-1000 hover:bg-blue-700 hover:text-white focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-md  px-5 py-2.5 me-2  dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
              >
                Pay now
              </Link>
            </div>
