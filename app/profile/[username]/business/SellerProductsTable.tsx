...
function SellerProductCard({ product, username }: RowProps) {
  return (
    ...
    >
      ...
      >
        <div className="relative flex h-24 w-24 items-center justify-center overflow-hidden rounded-md bg-white dark:bg-dark-bg">
          <Image
        ...
        <div className="flex flex-col gap-1">
          <span className="text-sm font-medium text-brand-muted dark:text-dark-muted">Product</span>
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div className="flex flex-col">
          <span className="text-sm text-brand-muted dark:text-dark-muted">Price</span>
